...
function Task({ taskInfo, actions }:
  ...
  }, [taskInfo.title, taskInfo.description]); // This effect runs whenever the task title or description changes
  ...
  }, [taskInfo.title]); // This effect runs whenever the task title changes
